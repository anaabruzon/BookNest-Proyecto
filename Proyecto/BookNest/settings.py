...
SECRET_KEY = 'django-insecure-((a-pb7y)moil4#%f5fdbvjme!jnt$7x%hu0!j@lu-35-bwr6i'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # Este es el archivo donde se almacenará la base de datos SQLite.
    }
}
